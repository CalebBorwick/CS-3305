...
int main() {
    ...
    FILE *ptr;
    int maxChar = 1000;
    char* file ="/Users/calebborwick/CLionProjects/CS_3305_Asn2_Part2/cpu_scheduling_input_file.txt";
    ptr = fopen(file, "r");
    char str[maxChar];
    char* outFile ="/Users/calebborwick/CLionProjects/CS_3305_Asn2_Part2/cpu_scheduling_output_file.txt";
